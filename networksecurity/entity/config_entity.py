...
class DataIngestionConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        """
        Initialize the DataIngestionConfig with the provided training pipeline configuration.
        
        :param training_pipeline_config: An instance of TrainingPipelineConfig containing pipeline details.
        """
